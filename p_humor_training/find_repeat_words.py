# -*- coding: utf-8 -*-
# Find sentences with repeated words (appears at least twice)
...
# Common meaningless words to skip
stop_words = set(['的', '了', '是', '在', '有', '和', '就', '不', '也', '都', '要', '会', '能', 
    ...
    '那个', '一个', '所以', '不会', '知道', '觉得', '看到', '想要', '这么', '那么', '一样',
    '一点', '一些', '不能', '只有', '时候', '地方', '为什么', '怎么样', '没', '多', '每', '两'])
